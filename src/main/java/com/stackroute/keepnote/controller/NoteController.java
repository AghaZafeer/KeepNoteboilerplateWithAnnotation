...
public class NoteController {
	...
	private Note getNote() {
		AnnotationConfigApplicationContext appContext = new AnnotationConfigApplicationContext(Note.class);
		return appContext.getBean("note",Note.class);
	}

	private NoteRepository getRepository() {
		AnnotationConfigApplicationContext appContext =new AnnotationConfigApplicationContext(NoteRepository.class);
